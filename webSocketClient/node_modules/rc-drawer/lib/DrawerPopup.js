...
function DrawerPopup(props) {
  ...
  var panelNode = /*#__PURE__*/React.createElement("div", {
    className: (0, _classnames.default)("".concat(prefixCls, "-content-wrapper")),
    style: (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, wrapperStyle), contentWrapperStyle), zIndexStyle)
